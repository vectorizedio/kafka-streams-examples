 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.2.0-standalone.jar io.confluent.examples.streams.ApplicationResetExample
 * }
 * </pre>
 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.2.0-standalone.jar io.confluent.examples.streams.ApplicationResetExample localhost:9092 --reset
 * }</pre>
