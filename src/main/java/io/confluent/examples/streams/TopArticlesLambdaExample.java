 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.2.0-standalone.jar io.confluent.examples.streams.TopArticlesLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-6.2.0-standalone.jar io.confluent.examples.streams.TopArticlesExampleDriver
 * }
 * </pre>
 */
